...
const copy = {
  en: { edit: 'Edit last message', hint: 'The reply after this message will be replaced.', send: 'Send', cancel: 'Cancel', error: 'Could not send. Please try again.' },
  ru: { edit: 'Редактировать последнее сообщение', hint: 'Ответ после этого сообщения будет заменён.', send: 'Отправить', cancel: 'Отмена', error: 'Не удалось отправить. Попробуйте ещё раз.' },
